<?php
	...
	if(isset($_SESSION["logado_usuario"]) && $_SESSION['logado_usuario'] == "sim")
	{
		if(isset($_POST['titulo']))
		{
			...
			$sql2 = "insert into fichatec_celulares (cod_produto, cod_marca_celular, cod_linha_celular,
			cod_modelo_celular, memoria_interna, memoria_ram, camera_traseira, camera_frontal) 
