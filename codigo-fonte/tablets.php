        ...
        <div class="col-lg-12 mt-5">
            ...
            <div class="card h-150 p-4">
                <div id="div_cel" class="form-row">
                    <div class="col-lg-12">
                        <h4>2. Tablets: preencha os dados referentes ao seu produto</h4>
                    </div>
                    <div class="col-5">
                    ...
                    <div class="col-7 row">
                        ...
                        <div class="alert alert-secondary mb-5 text-justify" role="alert">
                            Observação: Na próxima etapa você deverá preencher dados relacionados ao seu tablet.
                ...
                <div class="text-right mt-5">
                    <input value="Cadastrar" type="submit" id="btn_tablet" class="btn btn-secondary mt-4 btn-lg col-3"></input>
                </div>
            </div>
        </div>
    </div>
