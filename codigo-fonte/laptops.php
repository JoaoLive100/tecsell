        ...
        <div class="col-lg-12 mt-5">
            ...
            <div class="card h-150 p-4">
                <div id="div_cel" class="form-row">
                    <div class="col-lg-12">
                        <h4>2. Laptops: preencha os dados referentes ao seu produto</h4>
                    </div>
                    <div class="col-5">
                    ...
                    <div class="col-7 row">
                        ...
                        <div class="alert alert-secondary mb-5 text-justify" role="alert">
                            Observação: Na próxima etapa você deverá preencher dados relacionados ao seu laptop.
                             Se desejar informar mais detalhes a respeito de resolução da tela, marca de componentes, estado
                ...
                <div class="text-right mt-5">
                    <input value="Cadastrar" type="submit" id="btn_laptop" class="btn btn-secondary mt-4 btn-lg col-3"></input>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function get_image_data() {
        ...
        var inputhd = $("#inputHD").val();
        var inputssd = $("#inputSSD").val();
        ...
        else
        {
            ...
            form.append("tiporam", tiporam);
            form.append("ram", ram);
            form.append("marcaproc", marcaproc);
            form.append("modeloproc", modeloproc);
            form.append("inputhd", inputhd);
            form.append("inputssd", inputssd);
            form.append("check2em1", check2em1);
            form.append("checkgamer", checkgamer);
            form.append("checkultrabook", checkultrabook);
            form.append("checkplacadevideo", checkplacadevideo);
            form.append("checkwindows", checkwindows);
            form.append("checklinux", checklinux);
            form.append("checkmacos", checkmacos);
            form.append("checkusbc", checkusbc);
            form.append("checkssd", checkssd);
            return form;
   	}
    //upload do formulario para o banco de dados
    $("#btn_laptop").click(function (e) {
       e.preventDefault();
        $.ajax({
            url: "c_laptop.php",
            type: "POST",
